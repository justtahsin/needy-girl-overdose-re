...
public class Event_jinsei2 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_jinsei2 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_jinsei2 event_jinsei = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					((NgoEvent)event_jinsei).startEvent(cancellationToken);
					SingletonMonoBehaviour<PoketterManager>.Instance.AddQueueWithKusoreps(TweetType.Tweet289);
					UniTask val = NgoEvent.DelaySkippable(4400);
