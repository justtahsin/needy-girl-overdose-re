...
public class Scenario_horror_day4_Afterhaisin : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Scenario_horror_day4_Afterhaisin _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Scenario_horror_day4_Afterhaisin scenario_horror_day4_Afterhaisin = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				if (num != 0)
				{
					...
					((NgoEvent)scenario_horror_day4_Afterhaisin).startEvent(cancellationToken);
					SingletonMonoBehaviour<TaskbarManager>.Instance.SetTaskbarInteractive(interactive: false);
					val2 = SingletonMonoBehaviour<Poem>.Instance.StartPoem(NgoEx.SystemTextFromType(SystemTextType.Ending_KowaiInternet_Day4_Poem1, SingletonMonoBehaviour<Settings>.Instance.CurrentLanguage.Value));
				...
				val2 = SingletonMonoBehaviour<Poem>.Instance.StartPoem(NgoEx.SystemTextFromType(SystemTextType.Ending_KowaiInternet_Day4_Poem2, SingletonMonoBehaviour<Settings>.Instance.CurrentLanguage.Value));
				val = ((UniTask)(ref val2)).GetAwaiter();
				if (!((Awaiter)(ref val)).IsCompleted)
				{
					num = (_003C_003E1__state = 1);
				...
				scenario_horror_day4_Afterhaisin.endEvent();
			}
