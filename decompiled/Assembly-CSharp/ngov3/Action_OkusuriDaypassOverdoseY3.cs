...
public class Action_OkusuriDaypassOverdoseY3 : NgoEvent
{
	[CompilerGenerated]
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_OkusuriDaypassOverdoseY3 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_OkusuriDaypassOverdoseY3 action_OkusuriDaypassOverdoseY = _003C_003E4__this;
			try
			{
				UniTask val3;
				Awaiter val;
				...
				default:
					...
					((NgoEvent)action_OkusuriDaypassOverdoseY).startEvent(cancellationToken);
				...
				action_OkusuriDaypassOverdoseY.endEvent();
			}
