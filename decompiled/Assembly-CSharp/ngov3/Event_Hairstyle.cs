...
public class Event_Hairstyle : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_Hairstyle _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_Hairstyle CS_0024_003C_003E8__locals9 = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					...
					UniTask val = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Hairstyle_JINE001);
				...
				DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<CollectionAddEvent<JineData>>(Observable.Where<CollectionAddEvent<JineData>>(SingletonMonoBehaviour<JineManager>.Instance.OnChangeHistory, (Func<CollectionAddEvent<JineData>, bool>)((CollectionAddEvent<JineData> x) => x.Value.id == JineType.Event_Hairstyle_JINE001_Option002)), (Action<CollectionAddEvent<JineData>>)async delegate
				{
					SingletonMonoBehaviour<WebCamManager>.Instance.GoOut();
					PostEffectManager.Instance.AnmakuWeight(1f);
					await NgoEvent.DelaySkippable(3400);
				...
				DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<CollectionAddEvent<JineData>>(Observable.Where<CollectionAddEvent<JineData>>(SingletonMonoBehaviour<JineManager>.Instance.OnChangeHistory, (Func<CollectionAddEvent<JineData>, bool>)((CollectionAddEvent<JineData> x) => x.Value.id == JineType.Event_Hairstyle_JINE001_Option003)), (Action<CollectionAddEvent<JineData>>)async delegate
				{
					SingletonMonoBehaviour<WebCamManager>.Instance.GoOut();
					PostEffectManager.Instance.AnmakuWeight(1f);
					await NgoEvent.DelaySkippable(3400);
				...
				DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<CollectionAddEvent<JineData>>(Observable.Where<CollectionAddEvent<JineData>>(SingletonMonoBehaviour<JineManager>.Instance.OnChangeHistory, (Func<CollectionAddEvent<JineData>, bool>)((CollectionAddEvent<JineData> x) => x.Value.id == JineType.Event_Hairstyle_JINE001_Option004)), (Action<CollectionAddEvent<JineData>>)async delegate
				{
					SingletonMonoBehaviour<WebCamManager>.Instance.GoOut();
					PostEffectManager.Instance.AnmakuWeight(1f);
					await NgoEvent.DelaySkippable(3400);
