...
public class Test_GetLevel3Neta : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Test_GetLevel3Neta _003C_003E4__this;

		private void MoveNext()
		{
			int num = _003C_003E1__state;
			Test_GetLevel3Neta test_GetLevel3Neta = _003C_003E4__this;
			try
			{
				...
				try
				{
					while (enumerator.MoveNext())
					{
						...
						SingletonMonoBehaviour<NetaManager>.Instance.GetChip(gotChip, 3);
					}
				}
				finally
				{
