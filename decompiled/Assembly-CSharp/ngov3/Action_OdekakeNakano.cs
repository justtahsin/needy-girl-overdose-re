...
public class Action_OdekakeNakano : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_OdekakeNakano _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_OdekakeNakano action_OdekakeNakano = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				if (num != 0)
				{
					...
					action_OdekakeNakano.startEvent(cancellationToken, skipWatchSp: true);
					val2 = action_OdekakeNakano.GoOut();
				...
				val2 = action_OdekakeNakano.BackFromOdekake();
				val = ((UniTask)(ref val2)).GetAwaiter();
				if (!((Awaiter)(ref val)).IsCompleted)
				{
					num = (_003C_003E1__state = 1);
