...
public class Action_PlayIchatukuTalk : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_PlayIchatukuTalk _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_PlayIchatukuTalk action_PlayIchatukuTalk = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					action_PlayIchatukuTalk.startEvent(cancellationToken, skipWatchSp: true);
				...
				action_PlayIchatukuTalk.endEvent();
			}
