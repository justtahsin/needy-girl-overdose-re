...
public class ControllerGuide_Switch : ControllerGuide
{
	[Header("ヘッダーテキスト")]
	[SerializeField]
	...
	[SerializeField]
	private Text _desktop_LRPress_Header;
	...
	protected override void SetText(TabType type)
	{
		...
		case TabType.Desktop:
			...
			_desktop_LRPress_Header.text = NgoEx.SystemTextFromType(SystemTextType.SwitchGuide18, SingletonMonoBehaviour<Settings>.Instance.CurrentLanguage.Value);
