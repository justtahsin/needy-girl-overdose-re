...
public class Event_Test : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_Test _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_Test CS_0024_003C_003E8__locals3 = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				...
				val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Test_JINE001);
				val = ((UniTask)(ref val2)).GetAwaiter();
				if (!((Awaiter)(ref val)).IsCompleted)
				{
					num = (_003C_003E1__state = 1);
