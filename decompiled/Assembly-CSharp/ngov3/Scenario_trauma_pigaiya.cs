...
public class Scenario_trauma_pigaiya : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Scenario_trauma_pigaiya _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Scenario_trauma_pigaiya scenario_trauma_pigaiya = _003C_003E4__this;
			try
			{
				((NgoEvent)scenario_trauma_pigaiya).startEvent(cancellationToken);
				SingletonMonoBehaviour<EventManager>.Instance.AddEventQueue<Event_Dialog>();
				scenario_trauma_pigaiya.endEvent();
			}
