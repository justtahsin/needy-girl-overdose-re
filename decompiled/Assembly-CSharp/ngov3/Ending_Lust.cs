...
public class Ending_Lust : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Ending_Lust _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Ending_Lust ending_Lust = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				{
				default:
					((NgoEvent)ending_Lust).startEvent(cancellationToken);
					...
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Ending_Inran_JINE001);
				...
				case 2:
					...
					IL_00be:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Ending_Inran_JINE002);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 1);
