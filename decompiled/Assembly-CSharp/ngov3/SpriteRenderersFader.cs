...
public class SpriteRenderersFader : MonoBehaviour
{
	...
	private struct _003COnChangeAlpha_003Ed__5 : IAsyncStateMachine
	{
		...
		public SpriteRenderersFader _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			SpriteRenderersFader spriteRenderersFader = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				...
				List<SpriteRenderer>.Enumerator enumerator = spriteRenderersFader._renderers.GetEnumerator();
				try
				{
					while (enumerator.MoveNext())
					{
						...
						color.a = spriteRenderersFader._alpha;
						current.color = color;
					}
				}
				finally
