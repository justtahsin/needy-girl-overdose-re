...
public class Action_Internet2chY12 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_Internet2chY12 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_Internet2chY12 action_Internet2chY = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					action_Internet2chY.startEvent(cancellationToken, skipWatchSp: true);
					...
					UniTask val = NgoEvent.DelaySkippable(Constants.SLOW);
				...
				SingletonMonoBehaviour<PoketterManager>.Instance.AddQueueWithKusoreps(TweetFetcher.CommandTweet(CommandType.Kitsune_hyouban, CommandResult.success));
				action_Internet2chY.endEvent();
			}
