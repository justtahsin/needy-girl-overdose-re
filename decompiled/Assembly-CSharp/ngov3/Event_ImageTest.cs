...
public class Event_ImageTest : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_ImageTest _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_ImageTest event_ImageTest = _003C_003E4__this;
			try
			{
				((NgoEvent)event_ImageTest).startEvent(cancellationToken);
