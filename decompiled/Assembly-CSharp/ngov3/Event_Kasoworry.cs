...
public class Event_Kasoworry : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_Kasoworry _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_Kasoworry event_Kasoworry = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					((NgoEvent)event_Kasoworry).startEvent(cancellationToken);
					SingletonMonoBehaviour<JineManager>.Instance.addEventSeparator(JineType.Jine_Label_Status_FLow);
					UniTask val = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Kasoworry_JINE001);
	...
	{
		type = EventType.Event_Kasoworry;
		base.Awake();
	}
