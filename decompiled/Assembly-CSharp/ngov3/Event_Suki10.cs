...
public class Event_Suki10 : NgoEvent
{
	...
	private struct _003CConsumerStartEvent_003Ed__2 : IAsyncStateMachine
	{
		...
		public Event_Suki10 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_Suki10 event_Suki = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				default:
					...
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Suki10_JINE001);
				...
				case 2:
					...
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Suki10_JINE002);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
					...
					val2 = NgoEvent.DelaySkippable(6000);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 1);
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		private void MoveNext()
		{
			...
			try
			{
				...
				{
				default:
					((NgoEvent)event_Suki).startEvent(cancellationToken);
					SingletonMonoBehaviour<JineManager>.Instance.addEventSeparator(JineType.Jine_Label_days);
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Suki10_JINE001);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
