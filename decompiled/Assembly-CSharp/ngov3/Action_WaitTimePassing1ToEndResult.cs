...
public class Action_WaitTimePassing1ToEndResult : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_WaitTimePassing1ToEndResult _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_WaitTimePassing1ToEndResult CS_0024_003C_003E8__locals3 = _003C_003E4__this;
			try
			{
				((NgoEvent)CS_0024_003C_003E8__locals3).startEvent(cancellationToken);
				DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<bool>(Observable.Take<bool>(Observable.Where<bool>((IObservable<bool>)SingletonMonoBehaviour<EventManager>.Instance.isResulting, (Func<bool, bool>)((bool v) => !v)), 1), (Action<bool>)delegate
				{
