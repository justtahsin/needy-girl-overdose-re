...
public class StartWatchingSp : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public StartWatchingSp _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			StartWatchingSp startWatchingSp = _003C_003E4__this;
			try
			{
				((NgoEvent)startWatchingSp).startEvent(cancellationToken);
				SingletonMonoBehaviour<WebCamManager>.Instance.WatchSp();
				startWatchingSp.endEvent();
			}
