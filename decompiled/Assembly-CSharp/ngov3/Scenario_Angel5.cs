...
public class Scenario_Angel5 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Scenario_Angel5 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Scenario_Angel5 scenario_Angel = _003C_003E4__this;
			try
			{
				...
				SingletonMonoBehaviour<EventManager>.Instance.getChip(AlphaType.Angel, 5);
