...
public class StressHi_FollowHi_1 : NgoEvent
{
	...
	private struct _003CConsumerStartEvent_003Ed__2 : IAsyncStateMachine
	{
		...
		public StressHi_FollowHi_1 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			StressHi_FollowHi_1 CS_0024_003C_003E8__locals2 = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				default:
					...
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						...
						_003C_003Eu__1 = val;
						((AsyncUniTaskMethodBuilder)(ref _003C_003Et__builder)).AwaitUnsafeOnCompleted<Awaiter, _003CConsumerStartEvent_003Ed__2>(ref val, ref this);
						return;
					}
					goto IL_0092;
				case 0:
				...
				case 4:
					...
					IL_0092:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.StHi_FollowHi1_001);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 1);
					...
					IL_0160:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.StHi_FollowHi1_003);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
					...
					IL_00f9:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.StHi_FollowHi1_002);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		private void MoveNext()
		{
			...
			int num = _003C_003E1__state;
			StressHi_FollowHi_1 CS_0024_003C_003E8__locals3 = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
