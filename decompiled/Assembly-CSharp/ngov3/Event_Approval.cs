...
public class Event_Approval : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_Approval _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_Approval event_Approval = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				if (num != 0)
				{
					...
					((NgoEvent)event_Approval).startEvent(cancellationToken);
					SingletonMonoBehaviour<JineManager>.Instance.addEventSeparator(JineType.Jine_Label_Status_FLow);
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Approval_JINE001);
				...
				val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Approval_JINE002);
				val = ((UniTask)(ref val2)).GetAwaiter();
				if (!((Awaiter)(ref val)).IsCompleted)
				{
					num = (_003C_003E1__state = 1);
