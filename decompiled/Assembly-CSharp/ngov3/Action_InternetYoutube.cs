...
public class Action_InternetYoutube : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_InternetYoutube _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_InternetYoutube action_InternetYoutube = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					action_InternetYoutube.startEvent(cancellationToken, skipWatchSp: true);
				...
				action_InternetYoutube.endEvent();
			}
