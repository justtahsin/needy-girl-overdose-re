...
public class TimePassing2 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public TimePassing2 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			TimePassing2 timePassing = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					...
					UniTask val = SingletonMonoBehaviour<StatusManager>.Instance.timePassing(2);
