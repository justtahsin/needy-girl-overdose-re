...
public class Action_OkusuriPuronModerate : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_OkusuriPuronModerate _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_OkusuriPuronModerate action_OkusuriPuronModerate = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					((NgoEvent)action_OkusuriPuronModerate).startEvent(cancellationToken);
				...
				SingletonMonoBehaviour<PoketterManager>.Instance.AddQueueWithKusoreps(TweetFetcher.CommandTweet(CommandType.Kusuri_sihan_normal, CommandResult.success));
				action_OkusuriPuronModerate.endEvent();
			}
