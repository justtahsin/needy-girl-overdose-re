...
public class Scenario_day0_poem : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Scenario_day0_poem _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Scenario_day0_poem scenario_day0_poem = _003C_003E4__this;
			try
			{
				((NgoEvent)scenario_day0_poem).startEvent(cancellationToken);
				SingletonMonoBehaviour<EventManager>.Instance.AddEventQueue<DayPassing>();
				scenario_day0_poem.endEvent();
			}
