...
public class Ending_Yarisute : NgoEvent
{
	...
	[CompilerGenerated]
	private struct _003CAsobareteru_003Ed__5 : IAsyncStateMachine
	{
		public int _003C_003E1__state;

		public AsyncUniTaskMethodBuilder _003C_003Et__builder;

		public Ending_Yarisute _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Ending_Yarisute ending_Yarisute = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				default:
					...
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						...
						_003C_003Eu__1 = val;
						((AsyncUniTaskMethodBuilder)(ref _003C_003Et__builder)).AwaitUnsafeOnCompleted<Awaiter, _003CAsobareteru_003Ed__5>(ref val, ref this);
						return;
					}
					goto IL_0083;
				case 0:
	...
	[StructLayout(LayoutKind.Auto)]
	[CompilerGenerated]
	private struct _003CIkari_003Ed__6 : IAsyncStateMachine
	{
		public int _003C_003E1__state;
			...
			try
			{
				...
				default:
					...
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 0);
						_003C_003Eu__1 = val;
						((AsyncUniTaskMethodBuilder)(ref _003C_003Et__builder)).AwaitUnsafeOnCompleted<Awaiter, _003CIkari_003Ed__6>(ref val, ref this);
						return;
					}
					goto IL_008b;
				case 0:
	...
	[StructLayout(LayoutKind.Auto)]
	[CompilerGenerated]
	private struct _003CStartOwakare_003Ed__2 : IAsyncStateMachine
	{
		public int _003C_003E1__state;
		...
		private void MoveNext()
		{
			...
			int num = _003C_003E1__state;
			Ending_Yarisute CS_0024_003C_003E8__locals2 = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				default:
					...
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Ending_Yarisute_LINE001);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 0);
						_003C_003Eu__1 = val;
						((AsyncUniTaskMethodBuilder)(ref _003C_003Et__builder)).AwaitUnsafeOnCompleted<Awaiter, _003CStartOwakare_003Ed__2>(ref val, ref this);
						return;
					}
					goto IL_0096;
				case 0:
				...
				case 4:
					...
					IL_01cb:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Ending_Yarisute_LINE005);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 4);
					...
					IL_0096:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Ending_Yarisute_LINE002);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 1);
					...
					IL_0164:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Ending_Yarisute_LINE004);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 3);
					...
					IL_00fd:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Ending_Yarisute_LINE003);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 2);
	...
	[StructLayout(LayoutKind.Auto)]
	[CompilerGenerated]
	private struct _003CYarisutend_003Ed__7 : IAsyncStateMachine
	{
		public int _003C_003E1__state;
			...
			try
			{
				...
				default:
					...
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 0);
						_003C_003Eu__1 = val;
						((AsyncUniTaskMethodBuilder)(ref _003C_003Et__builder)).AwaitUnsafeOnCompleted<Awaiter, _003CYarisutend_003Ed__7>(ref val, ref this);
						return;
					}
					goto IL_0085;
				case 0:
				...
				((Awaiter)(ref val)).GetResult();
				DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<bool>(Observable.Where<bool>((IObservable<bool>)SingletonMonoBehaviour<PoketterManager>.Instance.isShootRunning, (Func<bool, bool>)((bool v) => !v)), (Action<bool>)delegate
				{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		private void MoveNext()
		{
			...
			//IL_015b: Unknown result type (might be due to invalid IL or missing references)
			int num = _003C_003E1__state;
			Ending_Yarisute CS_0024_003C_003E8__locals3 = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				default:
					...
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Jine_BeforeEnding_Yarisute000);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 0);
				...
				case 2:
					...
					IL_0128:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Jine_BeforeEnding_Yarisute004);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 2);
					...
					IL_00c1:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Jine_BeforeEnding_Yarisute003);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 1);
				...
				{
					CS_0024_003C_003E8__locals3.StartOwakare();
	...
	[AsyncStateMachine(typeof(_003CStartOwakare_003Ed__2))]
	private UniTask StartOwakare()
	{
		//IL_0002: Unknown result type (might be due to invalid IL or missing references)
		//IL_0007: Unknown result type (might be due to invalid IL or missing references)
		//IL_0031: Unknown result type (might be due to invalid IL or missing references)
		_003CStartOwakare_003Ed__2 _003CStartOwakare_003Ed__3 = default(_003CStartOwakare_003Ed__2);
		_003CStartOwakare_003Ed__3._003C_003Et__builder = AsyncUniTaskMethodBuilder.Create();
		_003CStartOwakare_003Ed__3._003C_003E4__this = this;
		_003CStartOwakare_003Ed__3._003C_003E1__state = -1;
		((AsyncUniTaskMethodBuilder)(ref _003CStartOwakare_003Ed__3._003C_003Et__builder)).Start<_003CStartOwakare_003Ed__2>(ref _003CStartOwakare_003Ed__3);
		return ((AsyncUniTaskMethodBuilder)(ref _003CStartOwakare_003Ed__3._003C_003Et__builder)).Task;
	}
	...
	private async void eventContinue1()
	{
		...
		DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<CollectionAddEvent<JineData>>(Observable.Where<CollectionAddEvent<JineData>>(SingletonMonoBehaviour<JineManager>.Instance.OnChangeHistory, (Func<CollectionAddEvent<JineData>, bool>)((CollectionAddEvent<JineData> x) => x.Value.id == JineType.Ending_Yarisute_LINE006_pi)), (Action<CollectionAddEvent<JineData>>)async delegate
		{
			eventContinue2();
	...
	[AsyncStateMachine(typeof(_003CAsobareteru_003Ed__5))]
	private UniTask Asobareteru()
	{
		//IL_0002: Unknown result type (might be due to invalid IL or missing references)
		//IL_0007: Unknown result type (might be due to invalid IL or missing references)
		//IL_0031: Unknown result type (might be due to invalid IL or missing references)
		_003CAsobareteru_003Ed__5 _003CAsobareteru_003Ed__6 = default(_003CAsobareteru_003Ed__5);
		_003CAsobareteru_003Ed__6._003C_003Et__builder = AsyncUniTaskMethodBuilder.Create();
		_003CAsobareteru_003Ed__6._003C_003E4__this = this;
		_003CAsobareteru_003Ed__6._003C_003E1__state = -1;
		((AsyncUniTaskMethodBuilder)(ref _003CAsobareteru_003Ed__6._003C_003Et__builder)).Start<_003CAsobareteru_003Ed__5>(ref _003CAsobareteru_003Ed__6);
		return ((AsyncUniTaskMethodBuilder)(ref _003CAsobareteru_003Ed__6._003C_003Et__builder)).Task;
	}

	[AsyncStateMachine(typeof(_003CIkari_003Ed__6))]
	private UniTask Ikari()
	{
		//IL_0002: Unknown result type (might be due to invalid IL or missing references)
		//IL_0007: Unknown result type (might be due to invalid IL or missing references)
		//IL_0031: Unknown result type (might be due to invalid IL or missing references)
		_003CIkari_003Ed__6 _003CIkari_003Ed__7 = default(_003CIkari_003Ed__6);
		_003CIkari_003Ed__7._003C_003Et__builder = AsyncUniTaskMethodBuilder.Create();
		_003CIkari_003Ed__7._003C_003E4__this = this;
		_003CIkari_003Ed__7._003C_003E1__state = -1;
		((AsyncUniTaskMethodBuilder)(ref _003CIkari_003Ed__7._003C_003Et__builder)).Start<_003CIkari_003Ed__6>(ref _003CIkari_003Ed__7);
		return ((AsyncUniTaskMethodBuilder)(ref _003CIkari_003Ed__7._003C_003Et__builder)).Task;
	}

	[AsyncStateMachine(typeof(_003CYarisutend_003Ed__7))]
	private UniTask Yarisutend()
	{
		//IL_0002: Unknown result type (might be due to invalid IL or missing references)
		//IL_0007: Unknown result type (might be due to invalid IL or missing references)
		//IL_0031: Unknown result type (might be due to invalid IL or missing references)
		_003CYarisutend_003Ed__7 _003CYarisutend_003Ed__8 = default(_003CYarisutend_003Ed__7);
		_003CYarisutend_003Ed__8._003C_003Et__builder = AsyncUniTaskMethodBuilder.Create();
		_003CYarisutend_003Ed__8._003C_003E4__this = this;
		_003CYarisutend_003Ed__8._003C_003E1__state = -1;
		((AsyncUniTaskMethodBuilder)(ref _003CYarisutend_003Ed__8._003C_003Et__builder)).Start<_003CYarisutend_003Ed__7>(ref _003CYarisutend_003Ed__8);
		return ((AsyncUniTaskMethodBuilder)(ref _003CYarisutend_003Ed__8._003C_003Et__builder)).Task;
	}
}
