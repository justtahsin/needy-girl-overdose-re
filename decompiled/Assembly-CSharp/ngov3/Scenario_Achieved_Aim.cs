...
public class Scenario_Achieved_Aim : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Scenario_Achieved_Aim _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Scenario_Achieved_Aim scenario_Achieved_Aim = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				{
				default:
					((NgoEvent)scenario_Achieved_Aim).startEvent(cancellationToken);
					AudioManager.Instance.PlayBgmByType(SoundType.BGM_event_happy);
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Aim_Achieved_Day14_JINE001);
				...
				case 2:
					...
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Aim_Achieved_Day14_JINE003);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
					...
					IL_009b:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Aim_Achieved_Day14_JINE002);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 1);
				...
				((Awaiter)(ref val)).GetResult();
				scenario_Achieved_Aim.endEvent();
			}
