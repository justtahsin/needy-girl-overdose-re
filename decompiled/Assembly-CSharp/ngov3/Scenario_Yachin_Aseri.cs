...
public class Scenario_Yachin_Aseri : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Scenario_Yachin_Aseri _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Scenario_Yachin_Aseri scenario_Yachin_Aseri = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				if (num != 0)
				{
					...
					((NgoEvent)scenario_Yachin_Aseri).startEvent(cancellationToken);
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Aim_NotAchieved_Day10_JINE001);
				...
				val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Aim_NotAchieved_Day10_JINE002);
				val = ((UniTask)(ref val2)).GetAwaiter();
				if (!((Awaiter)(ref val)).IsCompleted)
				{
					num = (_003C_003E1__state = 1);
				...
				IL_00e9:
				((Awaiter)(ref val)).GetResult();
				scenario_Yachin_Aseri.endEvent();
			}
