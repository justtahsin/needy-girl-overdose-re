...
public class Ending_Bad : NgoEvent
{
	...
	[CompilerGenerated]
	private struct _003Cnight_003Ed__2 : IAsyncStateMachine
	{
		public int _003C_003E1__state;

		public AsyncUniTaskMethodBuilder _003C_003Et__builder;

		public Ending_Bad _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Ending_Bad CS_0024_003C_003E8__locals2 = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				default:
					...
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Jine_Ending_bad000);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 0);
						_003C_003Eu__1 = val;
						((AsyncUniTaskMethodBuilder)(ref _003C_003Et__builder)).AwaitUnsafeOnCompleted<Awaiter, _003Cnight_003Ed__2>(ref val, ref this);
						return;
					}
					goto IL_009e;
				case 0:
				...
				case 6:
					...
					IL_009e:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Jine_Ending_bad001);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 1);
					...
					IL_0105:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Jine_Ending_bad002);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
				...
				DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<int>(Observable.Where<int>(ObserveExtensions.ObserveEveryValueChanged<PoketterManager, int>(SingletonMonoBehaviour<PoketterManager>.Instance, (Func<PoketterManager, int>)((PoketterManager pktr) => ((Collection<TweetData>)(object)pktr._tweetQueue).Count), (FrameCountType)0, false), (Func<int, bool>)((int count) => count == 0)), (Action<int>)async delegate
				{
					...
					await UniTask.Delay(Constants.SLOW * 2, false, (PlayerLoopTiming)8, default(CancellationToken), false);
					AchievementStatsUpdater.UpdateStats("Ending_Bad");
					SingletonMonoBehaviour<NotificationManager>.Instance.osimai();
					await UniTask.Delay(Constants.SLOW * 4000, false, (PlayerLoopTiming)8, default(CancellationToken), false);
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		private void MoveNext()
		{
			...
			int num = _003C_003E1__state;
			Ending_Bad CS_0024_003C_003E8__locals3 = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				default:
					...
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Jine_BeforeEnding_Bad000);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 0);
				...
				case 6:
					...
					IL_0269:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Jine_BeforeEnding_Bad005);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 5);
					...
					IL_00cd:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Jine_BeforeEnding_Bad001);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 1);
					...
					IL_0202:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Jine_BeforeEnding_Bad004);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 4);
					...
					IL_0134:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Jine_BeforeEnding_Bad002);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 2);
					...
					IL_02d0:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Jine_BeforeEnding_Bad006);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 6);
					...
					IL_019b:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Jine_BeforeEnding_Bad003);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 3);
	...
	[AsyncStateMachine(typeof(_003Cnight_003Ed__2))]
	private UniTask night()
	{
		//IL_0002: Unknown result type (might be due to invalid IL or missing references)
		//IL_0007: Unknown result type (might be due to invalid IL or missing references)
		//IL_0031: Unknown result type (might be due to invalid IL or missing references)
		_003Cnight_003Ed__2 _003Cnight_003Ed__3 = default(_003Cnight_003Ed__2);
		_003Cnight_003Ed__3._003C_003Et__builder = AsyncUniTaskMethodBuilder.Create();
		_003Cnight_003Ed__3._003C_003E4__this = this;
		_003Cnight_003Ed__3._003C_003E1__state = -1;
		((AsyncUniTaskMethodBuilder)(ref _003Cnight_003Ed__3._003C_003Et__builder)).Start<_003Cnight_003Ed__2>(ref _003Cnight_003Ed__3);
		return ((AsyncUniTaskMethodBuilder)(ref _003Cnight_003Ed__3._003C_003Et__builder)).Task;
	}
}
