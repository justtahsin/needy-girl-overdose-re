...
public class Scenario_poem_pigaiya : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Scenario_poem_pigaiya _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Scenario_poem_pigaiya scenario_poem_pigaiya = _003C_003E4__this;
			try
			{
				((NgoEvent)scenario_poem_pigaiya).startEvent(cancellationToken);
				scenario_poem_pigaiya.endEvent();
			}
