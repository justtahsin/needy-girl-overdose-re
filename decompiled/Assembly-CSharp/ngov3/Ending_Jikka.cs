...
public class Ending_Jikka : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Ending_Jikka _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Ending_Jikka ending_Jikka = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				{
				default:
					((NgoEvent)ending_Jikka).startEvent(cancellationToken);
					...
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Aim_NotAchieved_Day14_LINE001);
				...
				case 2:
					...
					IL_00c2:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Aim_NotAchieved_Day14_LINE002);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 1);
