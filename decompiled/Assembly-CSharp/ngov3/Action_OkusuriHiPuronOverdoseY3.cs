...
public class Action_OkusuriHiPuronOverdoseY3 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_OkusuriHiPuronOverdoseY3 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_OkusuriHiPuronOverdoseY3 action_OkusuriHiPuronOverdoseY = _003C_003E4__this;
			try
			{
				UniTask val3;
				Awaiter val;
				...
				default:
					...
					((NgoEvent)action_OkusuriHiPuronOverdoseY).startEvent(cancellationToken);
					if (SingletonMonoBehaviour<StatusManager>.Instance.GetStatus(StatusType.Stress) > 80)
					{
						val3 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Badtrip_Sihan_JINE001);
				...
				action_OkusuriHiPuronOverdoseY.endEvent();
			}
