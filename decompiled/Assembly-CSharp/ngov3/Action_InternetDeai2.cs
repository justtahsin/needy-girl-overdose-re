...
public class Action_InternetDeai2 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_InternetDeai2 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_InternetDeai2 action_InternetDeai = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				{
				default:
					action_InternetDeai.startEvent(cancellationToken, skipWatchSp: true);
					val2 = SingletonMonoBehaviour<WindowManager>.Instance.GetNakamiFromApp(AppType.Dinder).GetComponent<TinderView>().OnChoosed();
