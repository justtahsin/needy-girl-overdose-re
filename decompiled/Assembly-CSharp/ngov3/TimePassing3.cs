...
public class TimePassing3 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public TimePassing3 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			TimePassing3 timePassing = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					((NgoEvent)timePassing).startEvent(cancellationToken);
					...
					UniTask val = SingletonMonoBehaviour<StatusManager>.Instance.timePassing(3);
