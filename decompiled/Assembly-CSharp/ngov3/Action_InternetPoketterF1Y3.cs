...
public class Action_InternetPoketterF1Y3 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_InternetPoketterF1Y3 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_InternetPoketterF1Y3 action_InternetPoketterF1Y = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				...
				SingletonMonoBehaviour<PoketterManager>.Instance.AddQueueWithKusoreps(TweetFetcher.CommandTweet(CommandType.Tweet_ura_heraru, CommandResult.success));
