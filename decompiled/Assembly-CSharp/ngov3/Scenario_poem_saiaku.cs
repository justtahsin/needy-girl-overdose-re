...
public class Scenario_poem_saiaku : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Scenario_poem_saiaku _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Scenario_poem_saiaku scenario_poem_saiaku = _003C_003E4__this;
			try
			{
				((NgoEvent)scenario_poem_saiaku).startEvent(cancellationToken);
				scenario_poem_saiaku.endEvent();
			}
