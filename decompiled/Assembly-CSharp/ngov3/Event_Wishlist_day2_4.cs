...
public class Event_Wishlist_day2_4 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_Wishlist_day2_4 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_Wishlist_day2_4 CS_0024_003C_003E8__locals3 = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					...
					UniTask val = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Wishlist_JINE007);
