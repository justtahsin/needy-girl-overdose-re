...
public class Event_tekiTalk : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_tekiTalk _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_tekiTalk event_tekiTalk = _003C_003E4__this;
			try
			{
				((NgoEvent)event_tekiTalk).startEvent(cancellationToken);
				SingletonMonoBehaviour<JineManager>.Instance.AddJineHistoryFromString("もう喋ることない //種切れしました");
				event_tekiTalk.endEvent();
			}
