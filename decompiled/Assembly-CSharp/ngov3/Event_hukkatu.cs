...
public class Event_hukkatu : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_hukkatu _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_hukkatu event_hukkatu = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					((NgoEvent)event_hukkatu).startEvent(cancellationToken);
