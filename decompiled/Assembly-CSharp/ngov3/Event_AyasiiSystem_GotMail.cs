...
public class Event_AyasiiSystem_GotMail : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_AyasiiSystem_GotMail _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_AyasiiSystem_GotMail event_AyasiiSystem_GotMail = _003C_003E4__this;
			try
			{
				((NgoEvent)event_AyasiiSystem_GotMail).startEvent(cancellationToken);
				SingletonMonoBehaviour<WindowManager>.Instance.NewWindow(AppType.CrashMail);
				event_AyasiiSystem_GotMail.endEvent();
			}
