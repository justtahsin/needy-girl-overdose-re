...
public class Action_SleepToNight1 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_SleepToNight1 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_SleepToNight1 action_SleepToNight = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				if (num != 0)
				{
					...
					action_SleepToNight.startEvent(cancellationToken, skipWatchSp: true);
