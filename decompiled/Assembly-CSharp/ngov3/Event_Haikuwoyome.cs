...
public class Event_Haikuwoyome : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_Haikuwoyome _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_Haikuwoyome CS_0024_003C_003E8__locals3 = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				if (num != 0)
				{
					...
					val2 = ((NgoEvent)CS_0024_003C_003E8__locals3).startEvent(cancellationToken);
				...
				val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Haikuwoyome_JINE001);
				val = ((UniTask)(ref val2)).GetAwaiter();
				if (!((Awaiter)(ref val)).IsCompleted)
				{
					num = (_003C_003E1__state = 1);
				...
				DisposableExtensions.AddTo<IDisposable>(ObservableExtensions.Subscribe<string>((IObservable<string>)SingletonMonoBehaviour<JineManager>.Instance.Message, (Action<string>)async delegate(string m)
				{
					...
					await SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Haikuwoyome_JINE002);
