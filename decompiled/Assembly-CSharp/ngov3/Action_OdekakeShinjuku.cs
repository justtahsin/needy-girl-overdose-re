...
public class Action_OdekakeShinjuku : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_OdekakeShinjuku _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_OdekakeShinjuku action_OdekakeShinjuku = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				if (num != 0)
				{
					...
					action_OdekakeShinjuku.startEvent(cancellationToken, skipWatchSp: true);
					val2 = action_OdekakeShinjuku.GoOut();
				...
				val2 = action_OdekakeShinjuku.BackFromOdekake();
				val = ((UniTask)(ref val2)).GetAwaiter();
				if (!((Awaiter)(ref val)).IsCompleted)
				{
					num = (_003C_003E1__state = 1);
				...
				action_OdekakeShinjuku.endEvent();
			}
