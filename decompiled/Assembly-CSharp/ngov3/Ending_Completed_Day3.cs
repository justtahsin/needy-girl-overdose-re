...
public class Ending_Completed_Day3 : NgoEvent
{
	...
	public override async UniTask startEvent(CancellationToken cancellationToken = default(CancellationToken))
	{
		...
		await SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Jine_Ending_Completed_day3_000);
		await SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Jine_Ending_Completed_day3_001);
		...
		await UniTask.Delay(1000);
		SingletonMonoBehaviour<EventManager>.Instance.alpha = AlphaType.Otakutalk;
