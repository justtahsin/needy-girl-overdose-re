...
public class Ending_Healthy : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Ending_Healthy _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Ending_Healthy ending_Healthy = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				{
				default:
					((NgoEvent)ending_Healthy).startEvent(cancellationToken);
