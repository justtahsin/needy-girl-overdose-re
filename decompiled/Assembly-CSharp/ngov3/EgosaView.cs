...
public class EgosaView : MonoBehaviour
{
	...
	private async void Start()
	{
		...
		((Transform)musirect).localPosition = new Vector3(4f, -4f, 0f);
		await UniTask.Delay(120, false, (PlayerLoopTiming)8, default(CancellationToken), false);
		((Transform)musirect).localPosition = new Vector3(-4f, 4f, 0f);
		await UniTask.Delay(120, false, (PlayerLoopTiming)8, default(CancellationToken), false);
		((Transform)musirect).localPosition = new Vector3(4f, 4f, 0f);
		await UniTask.Delay(120, false, (PlayerLoopTiming)8, default(CancellationToken), false);
		((Transform)musirect).localPosition = new Vector3(-4f, -4f, 0f);
		await UniTask.Delay(120, false, (PlayerLoopTiming)8, default(CancellationToken), false);
		((Transform)musirect).localPosition = new Vector3(0f, 0f, 0f);
		await UniTask.Delay(120, false, (PlayerLoopTiming)8, default(CancellationToken), false);
		musimegane.SetActive(false);
	...
	private void ShowAllEgosas()
	{
		...
		{
			KusoRepView kusoRepView = Object.Instantiate<KusoRepView>(kusoPrefab, kusoParent);
			((Component)kusoRepView).gameObject.transform.SetAsLastSibling();
	...
	private void UpdateContents()
	{
		...
		KusoRepView kusoRepView2 = Object.Instantiate<KusoRepView>(kusoPrefab, kusoParent);
		((Component)kusoRepView2).gameObject.transform.SetAsLastSibling();
		...
		{
			KusoRepView kusoRepView3 = Object.Instantiate<KusoRepView>(kusoPrefab, kusoParent);
			((Component)kusoRepView3).gameObject.transform.SetAsLastSibling();
		...
		{
			KusoRepView kusoRepView4 = Object.Instantiate<KusoRepView>(kusoPrefab, kusoParent);
			((Component)kusoRepView4).gameObject.transform.SetAsLastSibling();
