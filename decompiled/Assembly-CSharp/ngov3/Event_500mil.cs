...
public class Event_500mil : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__0 : IAsyncStateMachine
	{
		...
		public Event_500mil _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_500mil event_500mil = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					((NgoEvent)event_500mil).startEvent(cancellationToken);
					UniTask val = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.follower500man);
