...
public class Status_Stress1_Night : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Status_Stress1_Night _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Status_Stress1_Night status_Stress1_Night = _003C_003E4__this;
			try
			{
				((NgoEvent)status_Stress1_Night).startEvent(cancellationToken);
				...
				TweenExtensions.Play<TweenerCore<Color, Color, ColorOptions>>(DOTweenModuleUI.DOColor(GameObject.Find("MainPanel").GetComponent<Image>(), new Color(1f, 1f, 1f, 1f), 32f));
				SingletonMonoBehaviour<EventManager>.Instance.AddEventQueue<Action_HaishinStart>();
				status_Stress1_Night.endEvent();
			}
