...
public class Event_Day20 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_Day20 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_Day20 event_Day = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				if (num != 0)
				{
					...
					((NgoEvent)event_Day).startEvent(cancellationToken);
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Day20_001);
				...
				val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Day20_002);
				val = ((UniTask)(ref val2)).GetAwaiter();
				if (!((Awaiter)(ref val)).IsCompleted)
				{
					num = (_003C_003E1__state = 1);
