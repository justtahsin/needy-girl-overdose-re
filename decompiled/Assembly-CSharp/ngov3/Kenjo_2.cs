...
public class Kenjo_2 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Kenjo_2 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Kenjo_2 kenjo_ = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				if (num != 0)
				{
					...
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.KenjoHi2_001);
				...
				val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.KenjoHi2_002);
				val = ((UniTask)(ref val2)).GetAwaiter();
				if (!((Awaiter)(ref val)).IsCompleted)
				{
					num = (_003C_003E1__state = 1);
