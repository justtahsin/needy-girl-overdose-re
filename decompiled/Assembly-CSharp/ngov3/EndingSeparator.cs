...
public class EndingSeparator : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public EndingSeparator _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			EndingSeparator endingSeparator = _003C_003E4__this;
			try
			{
				((NgoEvent)endingSeparator).startEvent(cancellationToken);
				SingletonMonoBehaviour<JineManager>.Instance.addEventSeparator(JineType.Jine_Label_BeforeEnd);
				endingSeparator.endEvent();
			}
