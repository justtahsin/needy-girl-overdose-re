...
public class Event_jinsei4 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_jinsei4 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_jinsei4 event_jinsei = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					...
					SingletonMonoBehaviour<PoketterManager>.Instance.AddQueueWithKusoreps(TweetType.Tweet291);
