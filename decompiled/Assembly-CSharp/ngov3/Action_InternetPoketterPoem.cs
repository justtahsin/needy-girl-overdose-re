...
public class Action_InternetPoketterPoem : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_InternetPoketterPoem _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_InternetPoketterPoem action_InternetPoketterPoem = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					action_InternetPoketterPoem.startEvent(cancellationToken, skipWatchSp: true);
				...
				action_InternetPoketterPoem.endEvent();
			}
