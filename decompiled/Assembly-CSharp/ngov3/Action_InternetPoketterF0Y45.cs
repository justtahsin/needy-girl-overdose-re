...
public class Action_InternetPoketterF0Y45 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_InternetPoketterF0Y45 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_InternetPoketterF0Y45 action_InternetPoketterF0Y = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					action_InternetPoketterF0Y.startEvent(cancellationToken, skipWatchSp: true);
				...
				action_InternetPoketterF0Y.endEvent();
			}
