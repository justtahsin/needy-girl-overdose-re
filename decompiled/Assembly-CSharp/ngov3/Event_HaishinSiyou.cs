...
public class Event_HaishinSiyou : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_HaishinSiyou _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_HaishinSiyou event_HaishinSiyou = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					((NgoEvent)event_HaishinSiyou).startEvent(cancellationToken);
					UniTask val = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.HaishinSiyou);
