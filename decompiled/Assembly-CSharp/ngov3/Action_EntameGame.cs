...
public class Action_EntameGame : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_EntameGame _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_EntameGame action_EntameGame = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					action_EntameGame.startEvent(cancellationToken, skipWatchSp: true);
