...
public class Ending_Meta_haishin : LiveScenario
{
	...
	private struct _003CStartScenario_003Ed__1 : IAsyncStateMachine
	{
		...
		public Ending_Meta_haishin _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Ending_Meta_haishin ending_Meta_haishin = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					UniTask val = ((LiveScenario)ending_Meta_haishin).StartScenario();
