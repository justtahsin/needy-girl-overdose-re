...
public class Action_OkusuriPuronOverdoseY2 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_OkusuriPuronOverdoseY2 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_OkusuriPuronOverdoseY2 action_OkusuriPuronOverdoseY = _003C_003E4__this;
			try
			{
				UniTask val3;
				Awaiter val;
				...
				default:
					...
					((NgoEvent)action_OkusuriPuronOverdoseY).startEvent(cancellationToken);
				...
				action_OkusuriPuronOverdoseY.endEvent();
			}
