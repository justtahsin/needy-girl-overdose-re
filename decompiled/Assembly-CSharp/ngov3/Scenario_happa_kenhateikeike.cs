...
public class Scenario_happa_kenhateikeike : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Scenario_happa_kenhateikeike _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Scenario_happa_kenhateikeike scenario_happa_kenhateikeike = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				{
				default:
					((NgoEvent)scenario_happa_kenhateikeike).startEvent(cancellationToken);
				...
				((Awaiter)(ref val)).GetResult();
				scenario_happa_kenhateikeike.endEvent();
			}
