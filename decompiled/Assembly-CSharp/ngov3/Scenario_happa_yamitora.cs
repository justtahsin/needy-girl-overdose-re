...
public class Scenario_happa_yamitora : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Scenario_happa_yamitora _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Scenario_happa_yamitora scenario_happa_yamitora = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				{
				default:
					((NgoEvent)scenario_happa_yamitora).startEvent(cancellationToken);
				...
				((Awaiter)(ref val)).GetResult();
				scenario_happa_yamitora.endEvent();
			}
