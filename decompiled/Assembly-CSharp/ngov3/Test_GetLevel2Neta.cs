...
public class Test_GetLevel2Neta : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Test_GetLevel2Neta _003C_003E4__this;

		private void MoveNext()
		{
			int num = _003C_003E1__state;
			Test_GetLevel2Neta test_GetLevel2Neta = _003C_003E4__this;
			try
			{
				...
				try
				{
					while (enumerator.MoveNext())
					{
						...
						SingletonMonoBehaviour<NetaManager>.Instance.GetChip(gotChip, 2);
					}
				}
				finally
				{
