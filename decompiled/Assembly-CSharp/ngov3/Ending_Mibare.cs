...
public class Ending_Mibare : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Ending_Mibare _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Ending_Mibare ending_Mibare = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					((NgoEvent)ending_Mibare).startEvent(cancellationToken);
					...
					UniTask val = NgoEvent.DelaySkippable(1800);
