...
public class Event_300mil : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__0 : IAsyncStateMachine
	{
		...
		public Event_300mil _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_300mil event_300mil = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					((NgoEvent)event_300mil).startEvent(cancellationToken);
					UniTask val = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.follower300man);
