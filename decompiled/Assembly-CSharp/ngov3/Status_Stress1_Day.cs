...
public class Status_Stress1_Day : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Status_Stress1_Day _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Status_Stress1_Day status_Stress1_Day = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				WristcutView wristcutView = default(WristcutView);
				int dayIndex = default(int);
				IWindow window = default(IWindow);
				switch (num)
				{
				default:
					((NgoEvent)status_Stress1_Day).startEvent(cancellationToken);
					...
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Wristcat_JINE004);
				...
				case 8:
					...
					IL_02b2:
					((Awaiter)(ref val)).GetResult();
					window = SingletonMonoBehaviour<WindowManager>.Instance.NewWindow(AppType.Darkness);
					...
					IL_017f:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Wristcat_JINE006);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
					...
					((Awaiter)(ref val)).GetResult();
					wristcutView.OnGo(dayIndex);
					val2 = UniTask.Delay(1200, false, (PlayerLoopTiming)8, default(CancellationToken), false);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
					...
					IL_045a:
					((Awaiter)(ref val)).GetResult();
					wristcutView.OnCompleted();
					SingletonMonoBehaviour<WindowManager>.Instance.Close(window);
					break;
					IL_01e7:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Wristcat_JINE007);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
					...
					IL_0117:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Wristcat_JINE005);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 1);
