...
public class Test_GetLevel1Neta : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Test_GetLevel1Neta _003C_003E4__this;

		private void MoveNext()
		{
			int num = _003C_003E1__state;
			Test_GetLevel1Neta test_GetLevel1Neta = _003C_003E4__this;
			try
			{
				IEnumerator enumerator = Enum.GetValues(typeof(AlphaType)).GetEnumerator();
				try
				{
					while (enumerator.MoveNext())
					{
						AlphaType gotChip = (AlphaType)enumerator.Current;
						SingletonMonoBehaviour<NetaManager>.Instance.GetChip(gotChip, 1);
					}
				}
				finally
				{
