...
public class Event_Wishlist_day2_1 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_Wishlist_day2_1 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_Wishlist_day2_1 event_Wishlist_day2_ = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					((NgoEvent)event_Wishlist_day2_).startEvent(cancellationToken);
					SingletonMonoBehaviour<JineManager>.Instance.addEventSeparator(JineType.Jine_Label_days);
					UniTask val = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Wishlist_JINE004);
				...
				SingletonMonoBehaviour<PoketterManager>.Instance.AddQueueWithKusoreps(TweetType.Event_Wishlist_Tweet001);
				SingletonMonoBehaviour<StatusManager>.Instance.UpdateStatus(StatusType.Stress, -1);
				SingletonMonoBehaviour<JineManager>.Instance.StartStamp();
				event_Wishlist_day2_.endEvent();
			}
