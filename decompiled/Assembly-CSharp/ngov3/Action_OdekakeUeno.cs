...
public class Action_OdekakeUeno : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_OdekakeUeno _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_OdekakeUeno action_OdekakeUeno = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				if (num != 0)
				{
					...
					action_OdekakeUeno.startEvent(cancellationToken, skipWatchSp: true);
					val2 = action_OdekakeUeno.GoOut();
				...
				SingletonMonoBehaviour<PoketterManager>.Instance.AddQueueWithKusoreps(TweetFetcher.CommandTweet(CommandType.Odekake_ueno, CommandResult.success));
				SingletonMonoBehaviour<WindowManager>.Instance.NewWindow(AppType.Webcam);
				val2 = action_OdekakeUeno.BackFromOdekake();
				val = ((UniTask)(ref val2)).GetAwaiter();
				if (!((Awaiter)(ref val)).IsCompleted)
				{
					num = (_003C_003E1__state = 1);
