...
public class NightKaiwaSeparator : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public NightKaiwaSeparator _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			NightKaiwaSeparator nightKaiwaSeparator = _003C_003E4__this;
			try
			{
				((NgoEvent)nightKaiwaSeparator).startEvent(cancellationToken);
				SingletonMonoBehaviour<JineManager>.Instance.addEventSeparator(JineType.Jine_Label_Midnight);
				nightKaiwaSeparator.endEvent();
			}
