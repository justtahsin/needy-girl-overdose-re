...
public class Action_SleepToTomorrow3 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_SleepToTomorrow3 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_SleepToTomorrow3 action_SleepToTomorrow = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				if (num != 0)
				{
					...
					action_SleepToTomorrow.startEvent(cancellationToken, skipWatchSp: true);
				...
				action_SleepToTomorrow.endEvent();
			}
