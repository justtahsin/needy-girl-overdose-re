...
public class ChipGet_Otakutalk_5 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public ChipGet_Otakutalk_5 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			ChipGet_Otakutalk_5 chipGet_Otakutalk_ = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				default:
					...
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.NetaGet_OtakuTalk5_1);
				...
				case 3:
					...
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.NetaGet_OtakuTalk5_3);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
					...
					IL_0091:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.NetaGet_OtakuTalk5_2);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 1);
					...
					IL_015f:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.NetaGet_OtakuTalk5_4);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
