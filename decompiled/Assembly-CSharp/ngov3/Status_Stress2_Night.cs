...
public class Status_Stress2_Night : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Status_Stress2_Night _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Status_Stress2_Night status_Stress2_Night = _003C_003E4__this;
			try
			{
				((NgoEvent)status_Stress2_Night).startEvent(cancellationToken);
				...
				ShortcutExtensions.DORotate(GameObject.Find("MainPanel").transform, new Vector3(0f, 0f, 0f), 0.2f, (RotateMode)0);
				status_Stress2_Night.endEvent();
			}
