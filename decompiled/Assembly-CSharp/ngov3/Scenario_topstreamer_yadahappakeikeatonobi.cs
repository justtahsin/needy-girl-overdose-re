...
public class Scenario_topstreamer_yadahappakeikeatonobi : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Scenario_topstreamer_yadahappakeikeatonobi _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Scenario_topstreamer_yadahappakeikeatonobi scenario_topstreamer_yadahappakeikeatonobi = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				{
				default:
					((NgoEvent)scenario_topstreamer_yadahappakeikeatonobi).startEvent(cancellationToken);
				...
				((Awaiter)(ref val)).GetResult();
				scenario_topstreamer_yadahappakeikeatonobi.endEvent();
			}
