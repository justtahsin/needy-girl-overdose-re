...
public class Event_Amecalling_Kowai : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_Amecalling_Kowai _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_Amecalling_Kowai event_Amecalling_Kowai = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				if (num != 0)
				{
					...
					((NgoEvent)event_Amecalling_Kowai).startEvent(cancellationToken);
				...
				val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Amecalling_Kowai_JINE001);
				val = ((UniTask)(ref val2)).GetAwaiter();
				if (!((Awaiter)(ref val)).IsCompleted)
				{
					num = (_003C_003E1__state = 1);
				...
				event_Amecalling_Kowai.endEvent();
			}
