...
public class Scenario_trauma_saiaku : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Scenario_trauma_saiaku _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Scenario_trauma_saiaku scenario_trauma_saiaku = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					((NgoEvent)scenario_trauma_saiaku).startEvent(cancellationToken);
				...
				scenario_trauma_saiaku.endEvent();
			}
