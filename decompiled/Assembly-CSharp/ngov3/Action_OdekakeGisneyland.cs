...
public class Action_OdekakeGisneyland : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_OdekakeGisneyland _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_OdekakeGisneyland action_OdekakeGisneyland = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				if (num != 0)
				{
					...
					action_OdekakeGisneyland.startEvent(cancellationToken, skipWatchSp: true);
					val2 = action_OdekakeGisneyland.GoOut();
				...
				val2 = action_OdekakeGisneyland.BackFromOdekake();
				val = ((UniTask)(ref val2)).GetAwaiter();
				if (!((Awaiter)(ref val)).IsCompleted)
				{
					num = (_003C_003E1__state = 1);
				...
				action_OdekakeGisneyland.endEvent();
			}
