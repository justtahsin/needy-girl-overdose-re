...
public class Action_OkusuriDaypassModerate : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_OkusuriDaypassModerate _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_OkusuriDaypassModerate action_OkusuriDaypassModerate = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					((NgoEvent)action_OkusuriDaypassModerate).startEvent(cancellationToken);
					...
					UniTask val = NgoEvent.DelaySkippable(Constants.MIDDLE);
				...
				SingletonMonoBehaviour<PoketterManager>.Instance.AddQueueWithKusoreps(TweetFetcher.CommandTweet(CommandType.Kusuri_shohou_normal, CommandResult.success));
				action_OkusuriDaypassModerate.endEvent();
			}
