...
public class Ending_Sukisuki : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Ending_Sukisuki _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Ending_Sukisuki ending_Sukisuki = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				{
				default:
					((NgoEvent)ending_Sukisuki).startEvent(cancellationToken);
					...
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.JINE_Ending_Sukisuki001);
				...
				case 11:
					...
					IL_00d8:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.JINE_Ending_Sukisuki002);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 1);
					...
					if (!((Object)(object)SingletonMonoBehaviour<JineManager>.Instance == (Object)null))
					{
						val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.JINE_Ending_Sukisuki002);
						val = ((UniTask)(ref val2)).GetAwaiter();
						if (!((Awaiter)(ref val)).IsCompleted)
