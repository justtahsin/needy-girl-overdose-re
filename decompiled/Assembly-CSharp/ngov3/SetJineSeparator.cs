...
public class SetJineSeparator : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public SetJineSeparator _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			SetJineSeparator setJineSeparator = _003C_003E4__this;
			try
			{
				((NgoEvent)setJineSeparator).startEvent(cancellationToken);
				SingletonMonoBehaviour<JineManager>.Instance.addEventSeparator(JineType.Jine_Label_Neta);
				setJineSeparator.endEvent();
			}
