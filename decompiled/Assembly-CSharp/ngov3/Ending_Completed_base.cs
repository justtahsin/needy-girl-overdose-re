...
public class Ending_Completed_base : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Ending_Completed_base _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Ending_Completed_base ending_Completed_base = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				{
				default:
					((NgoEvent)ending_Completed_base).startEvent(cancellationToken);
				...
				case 10:
					...
					ending_Completed_base.tweetFromTip(SingletonMonoBehaviour<EventManager>.Instance.alpha, SingletonMonoBehaviour<EventManager>.Instance.alphaLevel);
					...
					val2 = ending_Completed_base.GoOut();
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 1);
				...
				ending_Completed_base.endEvent();
			}
