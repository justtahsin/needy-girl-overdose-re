...
public class BlurWatchingSp : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public BlurWatchingSp _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			BlurWatchingSp blurWatchingSp = _003C_003E4__this;
			try
			{
				((NgoEvent)blurWatchingSp).startEvent(cancellationToken);
				SingletonMonoBehaviour<WebCamManager>.Instance.RandomizeAmeAnimation();
				blurWatchingSp.endEvent();
			}
