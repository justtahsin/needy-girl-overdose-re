...
public class Action_OdekakeIkebukuro : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_OdekakeIkebukuro _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_OdekakeIkebukuro action_OdekakeIkebukuro = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				if (num != 0)
				{
					...
					action_OdekakeIkebukuro.startEvent(cancellationToken, skipWatchSp: true);
					val2 = action_OdekakeIkebukuro.GoOut();
				...
				val2 = action_OdekakeIkebukuro.BackFromOdekake();
				val = ((UniTask)(ref val2)).GetAwaiter();
				if (!((Awaiter)(ref val)).IsCompleted)
				{
					num = (_003C_003E1__state = 1);
				...
				action_OdekakeIkebukuro.endEvent();
			}
