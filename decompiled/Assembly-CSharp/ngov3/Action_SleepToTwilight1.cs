...
public class Action_SleepToTwilight1 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_SleepToTwilight1 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_SleepToTwilight1 action_SleepToTwilight = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				if (num != 0)
				{
					...
					action_SleepToTwilight.startEvent(cancellationToken, skipWatchSp: true);
				...
				action_SleepToTwilight.endEvent();
			}
