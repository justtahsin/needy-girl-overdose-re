...
public class Ending_Kyouso : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Ending_Kyouso _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Ending_Kyouso ending_Kyouso = _003C_003E4__this;
			try
			{
				((NgoEvent)ending_Kyouso).startEvent(cancellationToken);
