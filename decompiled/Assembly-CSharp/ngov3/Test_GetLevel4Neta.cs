...
public class Test_GetLevel4Neta : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Test_GetLevel4Neta _003C_003E4__this;

		private void MoveNext()
		{
			int num = _003C_003E1__state;
			Test_GetLevel4Neta test_GetLevel4Neta = _003C_003E4__this;
			try
			{
				...
				try
				{
					while (enumerator.MoveNext())
					{
						...
						SingletonMonoBehaviour<NetaManager>.Instance.GetChip(gotChip, 4);
					}
				}
				finally
				{
