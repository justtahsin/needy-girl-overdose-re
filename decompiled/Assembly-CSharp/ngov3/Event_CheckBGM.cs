...
public class Event_CheckBGM : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_CheckBGM _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_CheckBGM event_CheckBGM = _003C_003E4__this;
			try
			{
				((NgoEvent)event_CheckBGM).startEvent(cancellationToken);
				if (SingletonMonoBehaviour<StatusManager>.Instance.GetStatus(StatusType.DayIndex) == 1)
				{
					event_CheckBGM.endEvent();
				}
