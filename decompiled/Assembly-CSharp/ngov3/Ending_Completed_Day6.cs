...
public class Ending_Completed_Day6 : NgoEvent
{
	...
	public override async UniTask startEvent(CancellationToken cancellationToken = default(CancellationToken))
	{
		...
		await SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Jine_Ending_Completed_day6_000);
		...
		await UniTask.Delay(1000);
		SingletonMonoBehaviour<EventManager>.Instance.ApplyStatus(CmdType.OdekakeAkihabara);
		await UniTask.Delay(1000);
		...
		await UniTask.Delay(1000);
		SingletonMonoBehaviour<EventManager>.Instance.alpha = AlphaType.Taiken;
