...
public class Event_Nerarenai_Night : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_Nerarenai_Night _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_Nerarenai_Night event_Nerarenai_Night = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				if (num != 0)
				{
					...
					((NgoEvent)event_Nerarenai_Night).startEvent(cancellationToken);
					SingletonMonoBehaviour<JineManager>.Instance.addEventSeparator(JineType.Jine_Label_days);
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Nerarenai_Night001);
				...
				val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Nerarenai_Night002);
				val = ((UniTask)(ref val2)).GetAwaiter();
				if (!((Awaiter)(ref val)).IsCompleted)
				{
					num = (_003C_003E1__state = 1);
				...
				event_Nerarenai_Night.endEvent();
			}
