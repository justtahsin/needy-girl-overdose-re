...
public class Action_OdekakeHikarigaokaPark : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_OdekakeHikarigaokaPark _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_OdekakeHikarigaokaPark action_OdekakeHikarigaokaPark = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				if (num != 0)
				{
					...
					action_OdekakeHikarigaokaPark.startEvent(cancellationToken, skipWatchSp: true);
					val2 = action_OdekakeHikarigaokaPark.GoOut();
				...
				SingletonMonoBehaviour<PoketterManager>.Instance.AddQueueWithKusoreps(TweetFetcher.CommandTweet(CommandType.Odekake_hikarigaoka, CommandResult.success));
				SingletonMonoBehaviour<WindowManager>.Instance.NewWindow(AppType.Webcam);
				val2 = action_OdekakeHikarigaokaPark.BackFromOdekake();
				val = ((UniTask)(ref val2)).GetAwaiter();
				if (!((Awaiter)(ref val)).IsCompleted)
				{
					num = (_003C_003E1__state = 1);
				...
				action_OdekakeHikarigaokaPark.endEvent();
			}
