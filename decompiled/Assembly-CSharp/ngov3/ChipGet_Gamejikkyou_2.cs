...
public class ChipGet_Gamejikkyou_2 : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public ChipGet_Gamejikkyou_2 _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			ChipGet_Gamejikkyou_2 chipGet_Gamejikkyou_ = _003C_003E4__this;
			try
			{
				UniTask val2;
				Awaiter val;
				...
				default:
					...
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.NetaGet_Game2_1);
				...
				case 2:
					...
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.NetaGet_Game2_3);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
					...
					IL_008d:
					((Awaiter)(ref val)).GetResult();
					val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.NetaGet_Game2_2);
					val = ((UniTask)(ref val2)).GetAwaiter();
					if (!((Awaiter)(ref val)).IsCompleted)
					{
						num = (_003C_003E1__state = 1);
