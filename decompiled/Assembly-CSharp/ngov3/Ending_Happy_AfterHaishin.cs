...
public class Ending_Happy_AfterHaishin : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Ending_Happy_AfterHaishin _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Ending_Happy_AfterHaishin ending_Happy_AfterHaishin = _003C_003E4__this;
			try
			{
				Awaiter val2;
				if (num != 0)
				{
					((NgoEvent)ending_Happy_AfterHaishin).startEvent(cancellationToken);
					...
					UniTask val = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Ending_Happy_JINE001);
				...
				ending_Happy_AfterHaishin.endEvent();
			}
