...
public class Test_ShowAllKusorep : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Test_ShowAllKusorep _003C_003E4__this;

		private void MoveNext()
		{
			int num = _003C_003E1__state;
			Test_ShowAllKusorep test_ShowAllKusorep = _003C_003E4__this;
			try
			{
				List<KusoRepType> list = new List<KusoRepType>();
				IEnumerator enumerator = Enum.GetValues(typeof(KusoRepType)).GetEnumerator();
				try
				{
					while (enumerator.MoveNext())
					{
						KusoRepType item = (KusoRepType)enumerator.Current;
						list.Add(item);
					}
				}
				finally
