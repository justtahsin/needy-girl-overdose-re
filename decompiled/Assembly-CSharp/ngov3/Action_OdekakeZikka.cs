...
public class Action_OdekakeZikka : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Action_OdekakeZikka _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Action_OdekakeZikka action_OdekakeZikka = _003C_003E4__this;
			try
			{
				Awaiter val;
				UniTask val2;
				if (num != 0)
				{
					...
					((NgoEvent)action_OdekakeZikka).startEvent(cancellationToken);
					AudioManager.Instance?.PlayBgmByType(SoundType.BGM_event_emo, isLoop: true);
					val2 = action_OdekakeZikka.GoOut();
				...
				val2 = SingletonMonoBehaviour<JineManager>.Instance.AddJineHistory(JineType.Event_Hometown_JINE001);
				val = ((UniTask)(ref val2)).GetAwaiter();
				if (!((Awaiter)(ref val)).IsCompleted)
				{
					num = (_003C_003E1__state = 1);
