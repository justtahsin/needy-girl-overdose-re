...
public class Event_AyasiiSystem_Crasher : NgoEvent
{
	...
	private struct _003CstartEvent_003Ed__1 : IAsyncStateMachine
	{
		...
		public Event_AyasiiSystem_Crasher _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			Event_AyasiiSystem_Crasher event_AyasiiSystem_Crasher = _003C_003E4__this;
			try
			{
				if (num != 0)
				{
					((NgoEvent)event_AyasiiSystem_Crasher).startEvent(cancellationToken);
					_003Ci_003E5__2 = 0;
					goto IL_00b6;
				}
				...
				if (_003Ci_003E5__2 < 30)
				{
					...
					UniTask val2 = UniTask.Delay(4, false, (PlayerLoopTiming)8, default(CancellationToken), false);
				...
				event_AyasiiSystem_Crasher.endEvent();
			}
